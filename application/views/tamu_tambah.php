              ...
              <form class="form-horizontal" method="post" action="<?php echo base_url('tamu/simpan') ?>">
                <div class="card-body">                
                  <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                      <input type="text" class="form-control" name="id_tamu" placeholder="id_tamu" required>
                    </div>
                  </div>
                  <div class="form-group row">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                      <input type="text" class="form-control" name="nama_lenakgap" placeholder="nama Lengkap" required>
                    </div>
                  </div>
                  <div class="form-group row">
