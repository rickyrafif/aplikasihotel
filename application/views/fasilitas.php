              ...
              <div class="card-body">
                <table id="example2" class="table table-bordered table-hover">
                    ...
                    <tr>
                        ...
                        <td>
                        <a href=" <?php echo base_url('fasilitas/ubah').$value->id_fasilitas ?>" class="btn btn-sm btn-primary">Edit</a>
                        <a href=" <?php echo base_url('fasilitas/hapus').$value->id_fasilitas ?>" class="btn btn-sm btn-danger">Hapus</a>
                        </td>
                    </tr>
                        <?php 
                        endforeach;
